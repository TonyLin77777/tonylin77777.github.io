      ...
      if (!isNaN(val)) {
        ...
        if (val > 0) {
          ...
          if(val*3 > highest_money_won.eric) {
            ...
            document.getElementById('eric-highest-money-received').innerHTML = val*3;
          }
        } else if (val < 0) {
          wins.eric++;
          document.getElementById("display-wins-eric").innerHTML = wins.eric;
      ...
      if (!isNaN(val)) {
        ...
        if (val > 0) {
          ...
          if(val*3 > highest_money_won.mom) {
            ...
            document.getElementById('mom-highest-money-received').innerHTML = val*3;
          }
        } else if (val < 0) {
          wins.mom++;
          document.getElementById("display-wins-mom").innerHTML = wins.mom;
      ...
      if (!isNaN(val)) {
        ...
        if (val > 0) {
          ...
          if(val*3 > highest_money_won.dad) {
            ...
            document.getElementById('dad-highest-money-received').innerHTML = val*3;
          }
        } else if (val < 0) {
          wins.dad++;
          document.getElementById("display-wins-dad").innerHTML = wins.dad;
